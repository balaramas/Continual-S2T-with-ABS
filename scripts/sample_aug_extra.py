...
if __name__ == "__main__":
    ...
    with open(x_train_file[:-6] + 'lbs_aug_extra_st.tsv', 'w') as train_x_lbs_st_file:
        train_x_lbs_st_file.write(train_x_lbs.to_csv(sep='\t', index=False))
    with open(x_train_file[:-6] + 'rrs_aug_extra_st.tsv', 'w') as train_x_rrs_st_file:
