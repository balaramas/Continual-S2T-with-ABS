...
class MUSTC(Dataset):
    ...
    def __getitem__(
        ...
        wav_path, offset, n_frames, sr, tgt_utt, spk_id, \
            utt_id = self.data[n]
        waveform, _ = get_waveform(wav_path, frames=n_frames, start=offset)
        waveform = torch.from_numpy(waveform)
        return waveform, sr, tgt_utt, spk_id, utt_id
...
def process(args):
    ...
    for lang in MUSTC.LANGUAGES:
        ...
        for split in MUSTC.SPLITS:
            ...
            for _, _, tgt_utt, speaker_id, utt_id in tqdm(dataset):
            ...
            save_df_to_tsv(df, cur_root / f"{split}_{lang}_{args.task}.tsv")
        # Generate vocab
